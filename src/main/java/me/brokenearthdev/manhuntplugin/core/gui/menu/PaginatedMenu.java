...
public class PaginatedMenu extends GameMenu {
    ...
    protected final Map<HumanEntity, Integer> CURRENT_PAGE = new HashMap<>();
    ...
    public PaginatedMenu(String title, int rows) {
        ...
        closeActions.add(action -> {
            CURRENT_PAGE.remove(action.getPlayer());
        });
    }
    ...
    public void display(HumanEntity entity, int pageIndex) {
        ...
        CURRENT_PAGE.put(entity, pageIndex);
    }
    ...
    public void display(HumanEntity entity) {
        this.display(entity, CURRENT_PAGE.getOrDefault(entity, 0));
    }
