...
public class ItemFactory {
    ...
    public ItemFactory addLoreLines(List<String> str) {
        str.forEach(this::addLoreLine);
        return this;
    }
    
    public ItemFactory addLoreLines(String ...str) {
        return addLoreLines(Arrays.asList(str));
    }
    
    public ItemFactory emptyLoreLine() {
        return addLoreLine(" ");
    }
    ...
    public ItemFactory setArmorColor(Color color) {
        ...
        try {
            ...
            Manhunt.getInstance().getLogger().warning(e.getMessage());
        }
        return this;
    }
